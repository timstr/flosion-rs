...
use super::graph_ui_state::ObjectUiState;
...
struct ObjectData {
    ...
    // TODO: consider refactoring this to reuse make_ui_state for creating objects e.g.
    // without initialization or from archive
    create: Box<
        dyn Fn(
            &mut SoundGraph,
            &mut GraphUIState,
